...
class Loggen(Thread):
	...
	def __init__(self, thread_name, filepath, clear_existing_file_data, source_lines, no_bulk_lines, sleep_time, no_total_lines, prefix_no_lines):
		Thread.__init__(self)
		self.name = thread_name
		self.filepath = filepath
		self.clear_existing_file_data = clear_existing_file_data
		...
		self.fw = File_writer(self.filepath, self.clear_existing_file_data, self.source_lines, self.prefix_no_lines)
